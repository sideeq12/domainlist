    ...
    <nav className="fixed top-0 left-0 right-0 z-50 border-b border-[var(--border)] bg-[var(--bg-primary)]/95 backdrop-blur-sm">
      <div className="flex items-center h-14 px-3 sm:px-4 gap-2 sm:gap-4">
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          <span className="hidden sm:inline font-semibold text-sm text-[var(--text-primary)] tracking-tight">DomainDropper</span>
        </div>
        ...
        <div className="flex-1 max-w-xl mx-auto relative">
          ...
          <input
            ...
            placeholder="Search..."
            className="w-full h-9 pl-9 pr-8 sm:pr-10 bg-[var(--bg-panel)] border border-[var(--border)] rounded-lg text-sm text-[var(--text-primary)] placeholder:text-[var(--text-muted)] outline-none focus:border-[var(--primary)] transition-colors"
          />
          <div className="hidden sm:flex absolute right-3 top-1/2 -translate-y-1/2 items-center gap-1 text-[10px] text-[var(--text-muted)] font-medium">
        ...
        <div className="flex items-center gap-2 sm:gap-4 shrink-0">
          <div className="hidden md:flex items-center gap-2 text-xs text-[var(--text-muted)]">
            ...
            <span className="hidden lg:inline">Updated: </span>{lastUpdated}
          </div>
          <div className="hidden md:flex items-center gap-1.5 text-xs text-[var(--text-muted)]">
            <Globe className="w-3 h-3" />
            <span>{totalDomains.toLocaleString()}</span>
          </div>
          <button
